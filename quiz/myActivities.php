...
$result = query("SELECT b.judul, a.jawabanbenar, a.jawabansalah, a.score, a.tanggal FROM tbl_histori as a left join tbl_quiz as b on a.idquiz = b.idquiz WHERE username = '$username'");
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <table class="table table-responsive-sm table-hover table-bordered text-center">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th width="250px" scope="col">Tanggal</th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php $i = 1; ?>
